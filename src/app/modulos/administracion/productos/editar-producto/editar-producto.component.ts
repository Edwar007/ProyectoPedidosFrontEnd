...
export class EditarProductoComponent implements OnInit {
  ...
  constructor(private fb:FormBuilder, private route:ActivatedRoute, private servicioProducto:ProductoService, private router:Router){
  ...
  EditarProducto(){
    ...
    this.servicioProducto.EditarProducto(p).subscribe((datos:ModeloProducto)=>{
      ...
      alert("Error en la edicion del producto");
    })
  }
}
